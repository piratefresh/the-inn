...
export function Menu({ children, trigger, ...props }: MenuProps) {
  return (
    ...
    >
      ...
      >
        <HeadlessMenu.Items className="inline-flex flex-col z-tooltip absolute left-0 mt-2 w-48 lg:w-56 origin-top-right divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          {children}
        </HeadlessMenu.Items>
      </Transition>
    </HeadlessMenu>
