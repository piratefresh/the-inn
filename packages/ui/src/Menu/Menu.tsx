...
export function Menu({ children, trigger, ...props }: MenuProps) {
  return (
    ...
    >
      ...
      >
        <HeadlessMenu.Items className="flex flex-col z-tooltip absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          {children}
        </HeadlessMenu.Items>
      </Transition>
    </HeadlessMenu>
