...
import { UserCreateNestedOneWithoutHostedInput } from "../inputs/UserCreateNestedOneWithoutHostedInput";
import { Difficulty } from "../../enums/Difficulty";
import { Experiance } from "../../enums/Experiance";

@TypeGraphQL.InputType("CampaignCreateWithoutPlayersInput", {
  isAbstract: true
})
export class CampaignCreateWithoutPlayersInput {
  ...
  @TypeGraphQL.Field(_type => UserCreateNestedOneWithoutHostedInput, {
    nullable: false
  })
  game_master!: UserCreateNestedOneWithoutHostedInput;
