...
import { UserUpdateManyWithoutCampaignInput } from "../inputs/UserUpdateManyWithoutCampaignInput";
import { UserUpdateOneRequiredWithoutHostedInput } from "../inputs/UserUpdateOneRequiredWithoutHostedInput";

@TypeGraphQL.InputType("CampaignUpdateInput", {
  isAbstract: true
})
export class CampaignUpdateInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneRequiredWithoutHostedInput, {
    nullable: true
  })
  game_master?: UserUpdateOneRequiredWithoutHostedInput | undefined;

  @TypeGraphQL.Field(_type => UserUpdateManyWithoutCampaignInput, {
    nullable: true
  })
  players?: UserUpdateManyWithoutCampaignInput | undefined;
