/*
  ...
  - The values [One_Shot] on the enum `CampaignType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CampaignType_new" AS ENUM ('Campaign', 'OneShot');
